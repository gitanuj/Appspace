...
public class SysFS {
	...
	private static final String PATH_TO_CPUFREQ = "/sys/devices/system/cpu/cpu0/cpufreq/";
	
	// Names of files related to CPU
	private static final String SCALING_SETSPEED = PATH_TO_CPUFREQ + "scaling_setspeed";
	private static final String SCALING_AVAILABLE_FREQUENCIES = PATH_TO_CPUFREQ + "scaling_available_frequencies";
	private static final String SCALING_CUR_FREQ = PATH_TO_CPUFREQ + "scaling_cur_freq";
	private static final String SCALING_GOVERNOR = PATH_TO_CPUFREQ + "scaling_governor";
	private static final String SCALING_MAX_FREQ = PATH_TO_CPUFREQ + "scaling_max_freq";
	private static final String SCALING_MIN_FREQ = PATH_TO_CPUFREQ + "scaling_min_freq";
